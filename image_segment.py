...
def getAreaOfFood(img1):
	...
	_ ,contours, hierarchy = cv2.findContours(img_th, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE) #make change here
	...
	_ , contours, hierarchy = cv2.findContours(img_th, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
...
if __name__ == '__main__':
    img1 = cv2.imread(r'C:\Users\M Sc-2\Desktop\dataset\FooD\6_8.jpg')
